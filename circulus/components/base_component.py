...
class CircuitComponent(eqx.Module):
    ...
    def __call__(self, t: Any = 0.0, y: jax.Array = None, **kwargs) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        """
    ...
    @classmethod
    def solver_call(cls, t: float, y: jax.Array, args: Any) -> Tuple[jax.Array, jax.Array]:
        """
